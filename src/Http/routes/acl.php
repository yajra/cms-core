...
$router->get('users/{user}', UsersController::class . '@show')->name('administrator.users.show');
$router->get('users/{user}/edit', UsersController::class . '@edit')->name('administrator.users.edit');
...
$router->get('roles/{role}/edit', RolesController::class . '@edit')->name('administrator.roles.edit');
...
$router->get('permissions/{permission}/edit', PermissionsController::class . '@edit')->name('administrator.permissions.edit');
