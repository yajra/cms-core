<div class="row">
    <div class="col-sm-3">
        <div class="form-group {{ $errors->has('parameters[show_title]') ? 'has-error' : '' }}">
            ...
            {!! form()->select('parameters[show_title]', ['No', 'Yes'], $article->param('show_title'), ['id'=>'parameters[show_title]','class'=>'form-control']) !!}
        ...
        <div class="form-group {{ $errors->has('parameters[show_author]') ? 'has-error' : '' }}">
            ...
            {!! form()->select('parameters[show_author]', ['No', 'Yes'], $article->param('show_author'), ['id'=>'parameters[show_author]','class'=>'form-control']) !!}
        ...
        <div class="form-group {{ $errors->has('parameters[show_create_date]') ? 'has-error' : '' }}">
            ...
            {!! form()->select('parameters[show_create_date]', ['No', 'Yes'], $article->param('show_create_date'), ['id'=>'parameters[show_create_date]','class'=>'form-control']) !!}
        ...
        <div class="form-group {{ $errors->has('parameters[show_modify_date]') ? 'has-error' : '' }}">
            ...
            {!! form()->select('parameters[show_modify_date]', ['No', 'Yes'], $article->param('show_modify_date'), ['id'=>'parameters[show_modify_date]','class'=>'form-control']) !!}
        ...
        <div class="form-group {{ $errors->has('parameters[show_hits]') ? 'has-error' : '' }}">
            ...
            {!! form()->select('parameters[show_hits]', ['No', 'Yes'], $article->param('show_hits'), ['id'=>'parameters[show_hits]','class'=>'form-control']) !!}
