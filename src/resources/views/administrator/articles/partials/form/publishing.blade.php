<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {!! form()->textarea('parameters[meta_description]', $article->fluentParameters()->meta_description, ['placeholder' => trans('cms::article.field.meta_description_placeholder'), 'class' => 'form-control', 'rows' => 3, 'cols' => 3]) !!}
        </div>
        <div class="form-group">
            ...
            {!! form()->textarea('parameters[meta_keywords]', $article->fluentParameters()->meta_keywords, ['placeholder' => trans('cms::article.field.meta_keywords_placeholder'), 'class' => 'form-control', 'rows' => 3, 'cols' => 3]) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! form()->text('parameters[key_reference]', $article->fluentParameters()->key_reference, ['placeholder' => trans('cms::article.field.key_reference_placeholder'), 'class' => 'form-control']) !!}
        </div>
        <div class="form-group">
            ...
            {!! form()->textarea('parameters[content_rights]', $article->fluentParameters()->content_rights, ['placeholder' => trans('cms::article.field.content_rights_placeholder'), 'class' => 'form-control', 'rows' => 3, 'cols' => 3]) !!}
        </div>
        <div class="form-group">
            ...
            {!! form()->text('parameters[external_reference]', $article->fluentParameters()->external_reference, ['placeholder' => trans('cms::article.field.external_reference'), 'class' => 'form-control']) !!}
        </div>
    </div>
</div>