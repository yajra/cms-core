...
@section('title')
    {{trans('categories.edit.title')}} | @parent
@stop

@section('page-title')
    @pageHeader('categories.edit.page-title', 'categories.edit.page-desc', 'fa fa-edit')
@stop
...
@section('content')
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 style="color: #505b69;" class="box-title">{{trans('categories.edit.require')}}</h3>
        ...
        <div class="box-footer">
            <a href="{{ route('administrator.categories.index') }}" class="btn btn-warning text-bold">
                {{trans('categories.edit.button.cancel')}}
            </a>
            <button type="submit" class="btn btn-primary text-bold">
                {{trans('categories.edit.button.update')}}
            </button>
        </div>
    </div>
    {!! form()->close() !!}
